...
- There are various other features like getting insights from the document, a chatbot trained to give valuable insights from the document.
- Feature like question creation, a chatbot, after analysing its own response, generates questions related to the study, which can be in your mind too.

- Prompt Engineering is the way of training an AI model in a way you want the responses to be. There are multiple platforms where you can learn to play with a chatbot 
responding system, like OpenAI playground where we can set the temperature and penalties to modify the responses created by the model. For example, lowering the temperature 
when you want an exact answer while dealing with facts, or increasing it to increase the randomness of the response while writing some creative article or poem.
